    ...
    <header class="justify-content-between align-items-md-center pt-4">
      ...
      <div class="row">
        ...
        <div class="col-6 order-1">
          <img src="img/MIF-logo.svg" class="img-fluid mb-4 mt-1">
        </div>
      </div>
          ...
          <div class="collapse navbar-collapse" id="main_nav">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item dropdown has-megamenu">
                <a class="nav-link  dropdown-toggle" href="#" data-bs-toggle="dropdown"> Our research </a>
                <span></span>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link  dropdown-toggle" href="#" data-bs-toggle="dropdown"> Our initiatives </a>
                <span></span>
                  <ul class="dropdown-menu dropdown-menu-end">
                  <li><a class="dropdown-item" href="#"> Submenu item 1</a></li>
                  <li><a class="dropdown-item" href="#"> Submenu item 2 </a></li>
            ...
            <button class="btn btn-primary" type="submit">MIF.LIVE</button>
          </div> <!-- navbar-collapse.// -->
